...
import sty from "./PlasmicButton.module.css"; // plasmic-import: vYbpbNH9aVEQkI/css
    ...
    >
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__pkCZu)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? p.renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__qKTyH)}
                role={"img"}
              />
            ),
